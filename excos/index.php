...
<div id="screen" class="content-section-b">
    <div class="container">
        ...
        $query = $conn->query("SELECT * FROM excos ORDER BY id ASC ");

        if($query->num_rows > 0){
            while($row = $query->fetch_assoc()){
                $imageThumbURL = '../admin/users/admi/Excos-update/excosimages/'.$row["excos_image"];
                $imageURL = '../admin/users/admi/Excos-update/excosimages/'.$row["excos_image"];
                ?>
                <a href="<?php echo $imageURL; ?>" data-fancybox="group" data-caption="<?php echo $row["excos_title"]; ?>">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="<?php echo $imageThumbURL; ?>" alt="Excos Image" width="250" height="250">
                    </div>
                </a>
            <?php }
        } ?>
