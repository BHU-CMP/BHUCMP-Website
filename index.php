    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <h3>ADMISSION</h3>
                <p class="lead">For admission into the Department, applicants to meet some requirements, which includes:

                <ul>
                    <li>
                        A total of five (5) credits in WAEC and/or NECO in not more than two sittings.
                    </li>
                    <li>
                        A cut off point of at least 180 in JAMB.
                    </li>
                </ul>
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <h3>COURSES</h3>
                <p class="lead">Courses offered at the department have very active practical sessions.We offer a wide
                    range of courses such as Automata Theory, Organisation of programming languages, JAVA, Python, C,
                    C++ Programming languages<a href="#"> Read more...</a></p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <h3> TUTION</h3>
                <p class="lead">Acoomodation for admitted students is available on the University's campus location in
                    Auta Balefi,Karu,Nassarawa state which is meters away from the lecture halls. The tuition and
                    accomodation fees are available in this <a href="#">here</a>. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
        </div>
    </div>
...
<div id="contact" class="content-section-a">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 text-center wrap_title">
                <h2>Contact Us</h2>
                <p class="lead" style="margin-top:0">Waiting for you...</p>
            </div>
